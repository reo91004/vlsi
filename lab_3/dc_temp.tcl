...
set DESIGN_REF_DATA_PATH          "/home/dvlsi3/lab_3/rtl"  ;#  Absolute path prefix variable for library/design data.
...
set HIERARCHICAL_DESIGNS           "control_unit datapath top" ;# List of hierarchical block design names "DesignA DesignB" ...
set HIERARCHICAL_CELLS             "control_unit datapath top" ;# List of hierarchical block cell instance names "u_DesignA u_DesignB" ...
...
set ADDITIONAL_SEARCH_PATH        "/home/DB/SAED32_EDK/lib/stdcell_rvt/db_nldm\ 
                                   /home/dvlsi3/lab_3"  ;#  Additional search path to be added to the default search path (used by all tools)
...
set RTL_SOURCE_FILES  "control_unit.v datapath.v top.v" ;# Enter the list of source RTL files if reading from RTL
